...
class TestHTMLMinifier(unittest.TestCase):
    ...
    def test_comment(self) -> None:
        ...
        minified_str: str = minify_html(comment)
    ...
    def test_inline_comment(self) -> None:
        ...
        comment: str = '<body><!-- comment --><h1>Hello, World!</h1>'
        minified_str: str = minify_html(comment)
    ...
    def test_newlines(self) -> None:
        ...
        newlines: str = '<h1>pre\npost</h1>\n'
        minified_str: str = minify_html(newlines)
    ...
    def test_tabs(self) -> None:
        ...
        minified_str: str = minify_html(tabs)
    ...
    def test_carriage_returns(self) -> None:
        ...
        minified_str: str = minify_html(carriage_return)
    ...
    def test_neighboring_spaces(self) -> None:
        ...
        minified_str: str = minify_html(neighboring_spaces)
    ...
    def test_complex_html_file(self) -> None:
        """A complex html file."""
        ...
        minified_str: str = minify_html(html)
