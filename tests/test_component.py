...
class TestComponent(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.c = Component('index.html', path=EX_PROJECT_PATH)
        cls.c.load_file()
    ...
    def test_dir_level(self):
        ...
        sub_page = Component('subpage/index.html', path=EX_PROJECT_PATH)
        sub_sub_page = Component('subpage/subsubpage/index.html', path=EX_PROJECT_PATH)
